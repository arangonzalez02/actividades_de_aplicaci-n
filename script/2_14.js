//Crea un programa en Java Script para calcular la letra de un DNI que debe de introducir el usuario por teclado (en internet encontrarás la fórmula que lo calcula).

let dni, resultadoLetra;
let dniIncorrecto = true;
...
do {
    ...
    if (isNaN(dni)) {
        ...
        alert("El DNI es:" + dni + letra);
    }

} while (dniIncorrecto != true);
